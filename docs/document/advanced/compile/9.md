...
### Windows
    ...
    4. dll
        - [Microsoft.NETCore.App.Runtime.Mono.win-x64](https://www.nuget.org/packages/Microsoft.NETCore.App.Runtime.Mono.win-x64/9.0.0-preview.7.24405.7)，修改后缀为.zip，并解压
        - 根据`runtimes/win-x64/lib/net9.0`筛选`artifacts/bin/runtime/net9.0-windows-Debug-x64`中的dll
    ...
    5. lib
        - `artifacts/obj/mono/windows.x64.Debug/out/lib`
            ...
            - `monosgen-2.0.lib`
        - `artifacts/bin/native/net9.0-windows-Debug-x64`
...
### Linux
    ...
    2. Ubuntu 22
    3. 编译选项：[v9.0.11-Linux](https://github.com/crazytuzi/runtime/commit/4a515148d7f53991b673cd0f74e92afef8736f8d)
    4. 编译
    ...
    6. dll
        - [Microsoft.NETCore.App.Runtime.Mono.linux-x64](https://www.nuget.org/packages/Microsoft.NETCore.App.Runtime.Mono.linux-x64/9.0.0-preview.7.24405.7)，修改后缀为.zip，并解压
        - 根据`runtimes/linux-x64/lib/net9.0`筛选`artifacts/bin/runtime/net9.0-linux-Debug-x64`中的dll
    ...
    7. lib
        - `artifacts/obj/mono/linux.x64.Debug/out/lib`
            ...
            - `libmonosgen-2.0.a`
        - `artifacts/bin/runtime/net9.0-linux-Debug-x64`
...
### macOS
    ...
    2. 编译
        ...
        - Release：`./build.sh mono+libs -c release`
    3. include
        - `artifacts/bin/mono/osx.arm64.Debug/include`
    4. dll
        - [Microsoft.NETCore.App.Runtime.Mono.osx-arm64](https://www.nuget.org/packages/Microsoft.NETCore.App.Runtime.Mono.osx-arm64/9.0.0-preview.7.24405.7)，修改后缀为.zip，并解压
        - 根据`runtimes/osx-arm64/lib/net9.0`筛选`artifacts/bin/runtime/net9.0-osx-Debug-arm64`中的dll
        - `artifacts/bin/mono/osx.arm64.Debug/System.Private.CoreLib.dll`
    5. lib
        - `artifacts/obj/mono/osx.arm64.Debug/out/lib`
            - `libmono-component-debugger-static.a`
            - `libmono-component-debugger-stub-static.a`
            - `libmono-component-diagnostics_tracing-static.a`
            - `libmono-component-diagnostics_tracing-stub-static.a`
            ...
            - `libmono-profiler-aot.a`
            - `libmonosgen-2.0.a`
        - `artifacts/bin/runtime/net9.0-osx-Debug-arm64`
            - `libSystem.Globalization.Native.a`
        ...
        - `artifacts/bin/mono/osx.arm64.Debug`
            - `libcoreclr.dylib`
...
### Android
    ...
    5. dll
        - [Microsoft.NETCore.App.Runtime.Mono.android-arm64](https://www.nuget.org/packages/Microsoft.NETCore.App.Runtime.Mono.android-arm64/9.0.11)，修改后缀为.zip，并解压
        - 根据`runtimes/android-arm64/lib/net9.0`筛选`artifacts/bin/runtime/net9.0-android-Debug-arm64`中的dll
    ...
    6. lib
        - `artifacts/obj/mono/android.arm64.Debug/out/lib`
            ...
            - `libmonosgen-2.0.a`
            - `libmonosgen-2.0.so`
        - `artifacts/bin/runtime/net9.0-android-Debug-arm64`
            - `libSystem.Native.so`

---

### IOS
    1. 环境：[Testing Libraries on iOS, tvOS, and osx](https://github.com/dotnet/runtime/blob/main/docs/workflow/testing/libraries/testing-apple.md)
    2. 编译
        - Debug：`./build.sh mono+libs -os ios -arch arm64`
        - Release：`./build.sh mono+libs -os ios -arch arm64 -c release`
        - 拷贝`artifacts/obj/mono/System.Private.CoreLib/ios.arm64.Debug/PreTrim/System.Private.CoreLib.dll`到`artifacts/obj/mono/ios.arm64.Debug/cross/mono/mini`
    ...
    4. dll
        - [Microsoft.NETCore.App.Runtime.Mono.ios-arm64](https://www.nuget.org/packages/Microsoft.NETCore.App.Runtime.Mono.ios-arm64/9.0.11)，修改后缀为.zip，并解压
        - 根据`runtimes/ios-arm64/lib/net9.0`筛选`artifacts/bin/runtime/net9.0-ios-Debug-arm64`中的dll
        - `artifacts/obj/mono/System.Private.CoreLib/ios.arm64.Debug/PreTrim/System.Private.CoreLib.dll`
    5. lib
        -  `artifacts/obj/mono/ios.arm64.Debug/out/lib`
            ...
            - `libmono-component-marshal-ilgen-stub-static.a`
            - `libmonosgen-2.0.a`
        - `artifacts/bin/runtime/net9.0-ios-Debug-arm64`
            - `libSystem.Globalization.Native.a`
            - `libSystem.Globalization.Native.dylib`
            - `libSystem.IO.Compression.Native.dylib`
            - `libSystem.Native.dylib`
            - `libSystem.Net.Security.Native.dylib`
            - `libSystem.Security.Cryptography.Native.Apple.dylib`
        - `artifacts/obj/mono/ios.arm64.Debug/cross/mono/mini`
            - `System.Private.CoreLib.dll.a`
    6. Framework
        1. 新建`IOS`-`Framework`
        2. `Product`填写`Mono`
        3. `Language`选择`Objective-C`
        4. 不勾选`Include Documentation`
        5. `Minmum Deployments`选择`15.0`
        6. `Build Settings`-`Search Paths`-`Library Search Paths`-`Debug`选择`*dylib`目录
