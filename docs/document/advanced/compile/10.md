...
### Windows
    ...
    4. dll
        ...
        - 根据`runtimes/win-x64/lib/net9.0`筛选`artifacts/bin/runtime/net10.0-windows-Debug-x64`中的dll
    ...
    5. lib
        - `artifacts/obj/mono/windows.x64.Debug/out/lib`
            ...
            - `monosgen-2.0.lib`
        - `artifacts/bin/native/net10.0-windows-Debug-x64`
...
### Linux
    ...
    5. dll
        ...
        - 根据`runtimes/linux-x64/lib/net9.0`筛选`artifacts/bin/runtime/net10.0-linux-Debug-x64`中的dll
    ...
    6. lib
        - `artifacts/obj/mono/linux.x64.Debug/out/lib`
            ...
            - `libmonosgen-2.0.a`
        - `artifacts/bin/runtime/net10.0-linux-Debug-x64`
...
### macOS
    ...
    4. dll
        ...
        - 根据`runtimes/osx-arm64/lib/net9.0`筛选`artifacts/bin/runtime/net10.0-osx-Debug-arm64`中的dll
    ...
    5. lib
        - `artifacts/obj/mono/osx.arm64.Debug/out/lib`
            ...
            - `libmono-profiler-aot.a`
            - `libmonosgen-2.0.a`
        - `artifacts/bin/runtime/net10.0-osx-Debug-arm64`
            - `libSystem.Globalization.Native.a`
...
### Android
    ...
    5. dll
        - [Microsoft.NETCore.App.Runtime.Mono.android-arm64](https://www.nuget.org/packages/Microsoft.NETCore.App.Runtime.Mono.android-arm64/10.0.1)，修改后缀为.zip，并解压
        - 根据`runtimes/android-arm64/lib/net9.0`筛选`artifacts/bin/runtime/net10.0-android-Debug-arm64`中的dll
    ...
    6. lib
        - `artifacts/obj/mono/android.arm64.Debug/out/lib`
            ...
            - `libmonosgen-2.0.a`
            - `libmonosgen-2.0.so`
        - `artifacts/bin/runtime/net10.0-android-Debug-arm64`
            - `libSystem.Native.so`
...
### IOS
    ...
    4. dll
        - [Microsoft.NETCore.App.Runtime.Mono.ios-arm64](https://www.nuget.org/packages/Microsoft.NETCore.App.Runtime.Mono.ios-arm64/10.0.1)，修改后缀为.zip，并解压
        - 根据`runtimes/ios-arm64/lib/net9.0`筛选`artifacts/bin/runtime/net10.0-ios-Debug-arm64`中的dll
    ...
    5. lib
        -  `artifacts/obj/mono/ios.arm64.Debug/out/lib`
            ...
            - `libmono-component-marshal-ilgen-stub-static.a`
            - `libmonosgen-2.0.a`
        - `artifacts/bin/runtime/net10.0-ios-Debug-arm64`
            - `libSystem.Globalization.Native.a`
            - `libSystem.Globalization.Native.dylib`
            - `libSystem.IO.Compression.Native.dylib`
            - `libSystem.Native.dylib`
